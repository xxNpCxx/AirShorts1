...
export class CustomLoggerService implements LoggerService {
  ...
  private shouldLog(level: LogLevel): boolean {
    ...
    if (!this.isDebugMode && [LogLevel.LOG, LogLevel.WARN, LogLevel.ERROR].includes(level)) return true;
    return false;
  }
  ...
  private getUserId(update: any): string | number {
  ...
  private getUsername(update: any): string {
  ...
  private getText(update: any): string {
  ...
  private getCallbackData(update: any): string {
